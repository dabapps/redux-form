 ...
 */
const createReduxForm = (isReactNative, React, connect) => {
  const { Component } = React;
  const reduxFormConnector = createReduxFormConnector(
    isReactNative,
    React,
    connect
  );
  return (config, mapStateToProps, mapDispatchToProps, mergeProps, options) =>
    (WrappedComponent) => {
      const ReduxFormConnector = reduxFormConnector(
        WrappedComponent,
        mapStateToProps,
        mapDispatchToProps,
        mergeProps,
      ...
      class ConnectedForm extends Component {
        ...
        getWrappedInstance() {
          ...
          return this.refs.wrappedInstance.refs.wrappedInstance.refs
            .wrappedInstance;
        }
